export const LikeIcon = ({ className, ...otherProps }) => {
  return (
...
export const CommentIcon = ({ className, ...otherProps }) => {
  return (
...
export const GitHubIcon = ({ className, ...otherProps }) => {
  return (
    <svg
      width="24"
      height="24"
...
export const VisitIcon = ({ className, ...otherProps }) => {
  return (
    <svg
      width="24"
      height="24"
...
export const LineSvg = ({ className, ...otherProps }) => {
  return (
    <svg
      className={className}
      {...otherProps}
